...
## 0.26.1
- docs: added a guide (`docs/src/nat/eval.md`) and a `nat-eval-moderations` skill (with copy-paste `examples/`) for evaluating NAT/DRAgent workflows with `nat eval`, scoring outputs through DataRobot moderations exposed as a NAT custom evaluator.
