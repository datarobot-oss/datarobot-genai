...
- Moved LLM extended-reasoning helpers to `core.llm_parameters` (`default_reasoning_extra_body`, `apply_reasoning_to_parameters`); `dragent` delegates from `apply_reasoning_config`.
