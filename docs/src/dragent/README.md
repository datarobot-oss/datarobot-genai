...
| `--a2a` | Expose the agent via the Agent2Agent protocol (endpoints mounted under `/a2a/` by default; set `a2a.mount_path` in `workflow.yaml` to mount under a different suffix). |
