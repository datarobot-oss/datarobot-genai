...
The canonical example is [`e2e-tests/dragent/nat/workflow.yaml`](https://github.com/datarobot-oss/datarobot-genai/blob/main/e2e-tests/dragent/nat/workflow.yaml). The following sections match that file.
