...
from datarobot_genai.dragent.converters import convert_str_to_dragent_chat_chunk_response
...
GlobalTypeConverter.register_converter(convert_str_to_dragent_chat_chunk_response)
