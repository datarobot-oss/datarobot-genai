...
from datarobot_genai.dragent.converters import convert_event_to_dragent_event_response
...
GlobalTypeConverter.register_converter(convert_event_to_dragent_event_response)
