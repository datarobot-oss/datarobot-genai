...
class DataRobotMCPServer:
    ...
    def run(self, show_banner: bool = False) -> None:
        ...
        try:
            ...
            # Wire OAuth scope declarations last, once every component exists:
            # the dynamic ones registered above, plus anything pre_server_start
            # added. Wiring earlier leaves later components undeclared while
            # looking configured. The scope-validation middleware enforces
            # these declarations per tools/call.
