...
"""Helpers for deploying custom inference models to DataRobot MLOps."""
...
def target_type_from_string(s: str) -> str:
    m = {
...
def deploy_custom_model_impl(
    ...
    env, env_version_id = select_execution_environment(client, execution_environment_id)
    create_kw: dict[str, Any] = {
        "name": name,
        "target_type": target_type_from_string(target_type),
